        ...
        <jsp:include page="/WEB-INF/views/header.jsp"/>
            <div class="row align-items-md-stretch">
                <div class="col-md-6">
                	...
                	<h2 class="h2">병해충 분석하기</h2>
                        <div class="d-flex justify-content-center top">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="strawberry_disease" checked="checked">
                                <label class="form-check-label" for="inlineRadio1">딸기</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="tomato_disease">
