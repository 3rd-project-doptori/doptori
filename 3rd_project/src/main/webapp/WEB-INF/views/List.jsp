  ...
  <body>
	...
	function DiaryList(fm_num){
  	...
  	function callBack(data){
  		...
  		console.log(data);
  		$.each(data, (index, obj)=>{
  		var bList = "<div class='card'>";
  		bList += "<div id='heading" + obj.di_num + "'>";
  		bList += "<div class='schedule-slot-time'>";
  		bList += "<p>" + obj.di_date + "</p>";
  		bList += "</div>";
  		bList += "<div class='collapsed card-header' data-toggle='collapse' data-target='#collapse" + obj.di_num + "' aria-expanded='False' aria-controls='collapse" + obj_num + "'>";
  		...
  		bList += "</div>";
  		bList += "</div>";
  		bList += "<div id='collapse" + obj.di_num + "' class='collapse' aria-labelledby='heading" + di_num + "' data-parent='#accordion'>";
