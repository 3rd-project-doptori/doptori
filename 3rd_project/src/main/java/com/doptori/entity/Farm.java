...
public class Farm {
	...
	public int getFm_mb_num() {
		return fm_mb_num;
	}
	public void setFm_mb_num(int fm_mb_num) {
		this.fm_mb_num = fm_mb_num;
	}
	public int getFm_ad_num() {
		return fm_ad_num;
	}
	...
	public String toString() {
		return "Farm [fm_num=" + fm_num + ", fm_mb_num=" + fm_mb_num + ", fm_ad_num=" + fm_ad_num + ", fm_detail="
				+ fm_detail + ", fm_name=" + fm_name + ", fm_dong=" + fm_dong + ", fm_area=" + fm_area + ", fm_cp_num="
				+ fm_cp_num + "]";
	}
